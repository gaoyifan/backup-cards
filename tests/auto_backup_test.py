...
@pytest.mark.asyncio
async def test_handle_device_triggers_backup():
    """Test that handle_device triggers a backup when conditions are met."""
    ...
    assert backup_id == "abc123"


@pytest.mark.asyncio
async def test_handle_device_skips_when_unsupported():
    """Test that handle_device skips unsupported devices."""
    mock_device = MagicMock()
